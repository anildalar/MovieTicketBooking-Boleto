...
import '../i18n';
//import DefaultImport, { NamedImport } from 'somelibrary'
...
class MovieDetails2 extends Component {
    ...
    constructor(){
        super();
        //Constructor is also a espcial method whose job is to initialize the propertiies
    }

    //3. Method area
    render() {
        //Everyfunction return something
        return (
            <>
                ...
                <section className="movie-details-section padding-top padding-bottom">
                    ...
                    <div className="row justify-content-center flex-wrap-reverse mb--50">
                        ...
                        <div className="movie-details">
                            <h3 className="title">{this.props.t('photos')}</h3>
...
export default withTranslation()(MovieDetails2);//Function curry
//3.2 Named